...
public class Notification {
    ...
    @Pattern(regexp = "^(TICKET_CREATED|TICKET_ASSIGNED|TICKET_RESOLVED|TICKET_REJECTED|BOOKING_APPROVED|BOOKING_REJECTED|SYSTEM)$", 
             message = "Type must be one of: TICKET_CREATED, TICKET_ASSIGNED, TICKET_RESOLVED, TICKET_REJECTED, BOOKING_APPROVED, BOOKING_REJECTED, SYSTEM")
    private String type;
